  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <button
        ...
        className="px-6 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 disabled:bg-gray-400 transition-colors flex items-center justify-center min-w-[7rem]"
      >
