...
export default function Login() {
  ...
  return (
    <div className="flex-1 text-gray-100 font-mono flex items-center justify-center p-4 relative overflow-hidden">
      {/* Card */}
